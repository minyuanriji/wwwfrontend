...
/***/ 136:
/*!******************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/main.js?{"page":"pages%2Forder%2Flist"} ***!
  \******************************************************************************************/
...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/order/list.vue */ 137));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 137:
/*!***********************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/list.vue ***!
  \***********************************************************************/
/*! no static exports found */
...
/* harmony import */ var _list_vue_vue_type_template_id_6546c710_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=6546c710&scoped=true& */ 138);
...
/* harmony import */ var _list_vue_vue_type_style_index_0_id_6546c710_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&id=6546c710&lang=scss&scoped=true& */ 142);
...
/***/ 138:
/*!******************************************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/list.vue?vue&type=template&id=6546c710&scoped=true& ***!
  \******************************************************************************************************************/
...
var render = function() {
  ...
  var l0 =
    _vm.dataList && _vm.dataList.length
      ? _vm.__map(_vm.data_list, function(model, orderIndex) {
          var $orig = _vm.__get_orig(model)

          var f0 = _vm._f("totalNum")(model.detail)

          var g0 = model.total_pay_price.slice(0, -3)
          var g1 = model.total_pay_price.slice(-3)
          return {
            $orig: $orig,
            f0: f0,
            g0: g0,
...
/***/ 140:
/*!************************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/list.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 141:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/list.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var tuiButton = function tuiButton() {__webpack_require__.e(/*! require.ensure | components/extend/button/button */ "components/extend/button/button").then((function () {return resolve(__webpack_require__(/*! @/components/extend/button/button */ 1126));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var tuiListCell = function tuiListCell() {__webpack_require__.e(/*! require.ensure | components/list-cell/list-cell */ "components/list-cell/list-cell").then((function () {return resolve(__webpack_require__(/*! @/components/list-cell/list-cell */ 1063));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  computed: {
    ...
    data_list: function data_list() {var _this = this;
      if (this.status == -1) {
        return this.dataList;
      }
      return this.dataList.filter(function (item) {return item.status == _this.status;});
    } },

  methods: {
    toPage: function toPage(orderId, oddNum) {
      uni.navigateTo({
        url: "./logistics/index?orderId=".concat(orderId, "&odd=").concat(oddNum) });

    },
    // 提现发货
    remindSendById: function remindSendById(id) {var _this2 = this;
      this.$http.request({
    ...
    // 删除
    deleteOrderById: function deleteOrderById(id) {var _this3 = this;
      this.$http.request({
      ...
      then(function (res) {
        ...
        if (res.code === 0) {
          _this3.getDateList('refresh', _this3.status);
        }
      });
    },
    // 评价
    ...
    pay: function pay(id) {
      // console.log("支付", id);
      uni.navigateTo({
        url: "/pages/order/pay?orderId=".concat(id) });

    },
    // 确认收货
    confirm: function confirm(id) {var _this4 = this;
      this.$http.request({
      ...
      then(function (res) {
        ...
        if (res.code === 0) {
          _this4.getDateList('refresh', _this4.status);
        }
      });
    },
    // 取消订单
    cancel: function cancel(id) {var _this5 = this;
      this.$http.request({
      ...
      then(function (res) {
        ...
        if (res.code === 0) {
          _this5.getDateList('refresh', _this5.status);
        }
      });
    },
    // 通过 key 和 status 判断通过何种方式修改数据
    getDateList: function getDateList(key, status) {var _this6 = this;
      this.loading = true;
      // 如果 key == 'refresh' 重置数据
      if (key == 'refresh') {
        this.pages = {
      ...
      then(function (res) {
        ...
        if (res.code === 0) {var _res$data =
          ...
          _this6.dataList = key != 'refresh' ? _this6.dataList.concat(list) : list; // key != refresh 则是加载下一页数据
          _this6.pages = pagination;
          _this6.pullUpOn = true;
        }
      });
    },
    ...
    detail: function detail(id) {
      uni.navigateTo({
        url: "/pages/order/detail?orderId=".concat(id) });

    } },

  onPullDownRefresh: function onPullDownRefresh() {var _this7 = this;
    setTimeout(function () {
      uni.stopPullDownRefresh();
      _this7.getDateList('refresh', _this7.status);
    }, 1000);
  },
  ...
  filters: {
    ...
    totalNum: function totalNum(value) {
      var sum = 0;
...
/***/ 142:
/*!*********************************************************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/list.vue?vue&type=style&index=0&id=6546c710&lang=scss&scoped=true& ***!
  \*********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
