...
/***/ 144:
/*!********************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/main.js?{"page":"pages%2Forder%2Fdetail"} ***!
  \********************************************************************************************/
...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/order/detail.vue */ 145));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 145:
/*!*************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/detail.vue ***!
  \*************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _detail_vue_vue_type_template_id_57d42baa_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=57d42baa&scoped=true& */ 146);
...
/* harmony import */ var _detail_vue_vue_type_style_index_0_id_57d42baa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&id=57d42baa&lang=scss&scoped=true& */ 150);
...
/***/ 146:
/*!********************************************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/detail.vue?vue&type=template&id=57d42baa&scoped=true& ***!
  \********************************************************************************************************************/
...
var render = function() {
  ...
  var m0 = _vm.showRefund(_vm.detail.status)
  var m1 = _vm.undone(_vm.detail.status)
  var g0 =
    _vm.detail && _vm.detail.id ? _vm.detail.total_pay_price.slice(0, -3) : null
  var g1 =
    _vm.detail && _vm.detail.id ? _vm.detail.total_pay_price.slice(-3) : null
...
/***/ 148:
/*!**************************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/detail.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 149:
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/detail.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var tuiButton = function tuiButton() {__webpack_require__.e(/*! require.ensure | components/extend/button/button */ "components/extend/button/button").then((function () {return resolve(__webpack_require__(/*! @/components/extend/button/button */ 1126));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var commodity = function commodity() {__webpack_require__.e(/*! require.ensure | components/commodity/commodity */ "components/commodity/commodity").then((function () {return resolve(__webpack_require__(/*! @/components/commodity/commodity */ 1506));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
...

{
  ...
  computed: {
    ...
    showRefund: function showRefund() {
      return function (value) {
        var _notShow = [0, 4, 5, 8];
        var temp;
        value == 0 ? temp = true : temp = _notShow.find(function (v) {return v == value;});
  ...
  methods: {
    ...
    toGoodsDateil: function toGoodsDateil(id) {
      //判断是否为拼团订单
      if (this.active_status) {
        uni.navigateTo({
          url: "/mch/group-buy/good?proId=".concat(id) });

      } else {
        uni.navigateTo({
          url: "../goods/detail?proId=".concat(id) });

      }

    },
    remindSendById: function remindSendById(id) {var _this3 = this;
      this.$http.request({
    ...
    deleteOrderById: function deleteOrderById(id) {var _this4 = this;
      this.$http.request({
    ...
    goRefund: function goRefund(id) {
      uni.navigateTo({
        url: "./refund/type?id=".concat(id) });

    },
    confirm: function confirm(id) {var _this5 = this;
      this.$http.request({
      ...
      then(function (res) {
        ...
        if (res.code === 0) {
          _this5.getDetail(id, false);
        }
      });
    },
    cancel: function cancel(id) {var _this6 = this;
      this.$http.request({
    ...
    getDetail: function getDetail(id, bool) {var _this7 = this;
      this.loading = bool;
      this.$http.request({
      ...
      then(function (res) {
        ...
        if (res.code === 0) {
          _this7.detail = res.data.detail;
          _this7.is_show = _this7.detail.order_goods_list.some(function (v) {return v.diy_refund_status == 0;});
          switch (_this7.detail.status) {
            case 0:
              _this7.title_text = '待付款';
              break;
            case 1:
              _this7.title_text = '待发货';
              break;
            case 2:
              _this7.title_text = '待收货';
              break;
            case 3:
              _this7.title_text = '待评价';
              break;}
...
/***/ 150:
/*!***********************************************************************************************************************************!*\
  !*** /Users/apple/wwwweb/gongsi_sc/公司文件/前端代码/前端/pages/order/detail.vue?vue&type=style&index=0&id=57d42baa&lang=scss&scoped=true& ***!
  \***********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
