					...
					<view class="reward-info">
						<view class="reward-info-cont">
							<view class="reward-info-box">
								<view>累计奖励</view>
								<view><text>¥</text>{{detail.rebuy_total_price}}</view>
							</view>
							<view class="reward-info-box">
								<view>上月发放奖励</view>
								<view><text>¥</text>{{detail.rebuy_last_price}}</view>
							</view>
						...
						<view class="reward-details-box">
							<view class="reward-details-cont" v-if="list.length" v-for="(item,index) in list">
								<view class="reward-details-cont-info">
									...
									<view class="reward-details-cont-info-n">订单总金额：{{item.total_order_price}}元</view>
									<view class="reward-details-cont-info-n">商品总数量：{{item.total_order_goods_num}}件</view>
									<view class="reward-details-cont-info-time">2020-05-12 10:16</view>
								</view>
