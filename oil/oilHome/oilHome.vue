	...
	<view class="oilHome-container">
		...
		<view class="main">
			...
			<view class="select_num">
				...
				<view class="num_list">
					<view class="item" v-for="(item,index) in 4 " :key='index' @click="selectNum(item)">
						<view style="text-align: center;margin: 35rpx 0 0 0;color: rgb(37,130,234);">
							<text style="font-size: 26rpx;font-weight: bold;">￥</text>
							<text  style="font-size: 40rpx;font-weight: bold;">100</text>
						</view>
			...
			<view class="popup_view">
				<view class="popup_view_header">
					...
					<view>
						...
						<text style="display: block;color: #000;font-weight: bold;">{{form.phone}}</text>
					</view>
				</view>
				<view class="popup_view_denomination">
					<view style="line-height: 100rpx;color: #000;">加油卷面额</view>
					<view style="line-height: 100rpx;color: rgb(255,129,71);">￥100</view>
				</view>
				<view class="use-points">
					<view style="color: #000;">使用红包 <view class="xieti" style="font-size: 18rpx;color: #666;">拥有红包：10000
						<text class="text" v-if="is_checked" style="font-style: oblique;color: #F53939;margin-left: 20rpx;padding-right: 10rpx;">-12</text>
					</view>
					</view>
				...
				<view class="count">					
					<view style="line-height:120rpx;margin-left: 30rpx;">
						...
						<text style="color: rgb(255,129,71);">￥100</text>
					</view>
