<template>
	<div class="out-box" :style="cOutStyle">
		<view class="diy-take-score" :style="cStyle">
			<image v-if="data.pic_url" :src="data.pic_url" :style="cImgStyle"></image>
...
<script>
	export default {
		...
		computed:{
			cOutStyle(){
				let style = {};
				style['height'] = this.window_h + "rpx";
				return style;
			},
			cButtonStyle(){
...
.out-box{position:fixed;left:0;top:0;background:RGBA(255, 255, 255, 0.5);width:100%;display:flex;align-items: center;justify-content: center;}
