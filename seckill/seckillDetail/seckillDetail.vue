					...
					<view class="time-money">
						<view class="time-money-left">
							<view style="height: 60rpx;line-height: 60rpx;">
								<text style="font-size: 30rpx;color: #fff;width: 120rpx;background: #007AFF;line-height: 44rpx;text-align: center;border-radius: 30rpx;">秒杀价</text>
								<text style="font-weight: bold;">￥</text>
								<text style="font-size: 48rpx;font-weight: bold;">100</text>
							</view>
							<view>
								<text style="font-size: 28rpx;color: #fff;margin-left: 10rpx;">原价</text>
								<text style="font-size: 28rpx;color: #fff;text-decoration: line-through;">￥121</text>
							</view>
						</view>
					</view>
				</view>
					...
					this.$http.request({
						...
						if (res.code == 0) {
							...
							if (this.sign == 'short_video') {
								url = `/seckill/submit/submit?sign=${this.sign}&related_user_id=${this.related_user_id}&mch_id=${mch_id}`;
							} else {
								url = '/seckill/submit/submit';
							}
							// #ifdef H5
